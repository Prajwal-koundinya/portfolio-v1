...
const navItems = [
  ...
  { label: "Achievements", href: "/workbench" },
  { label: "Connect", href: "#connect" },
]

const socialLinks = [
  { label: "GitHub", href: "https://github.com/Prajwal-koundinya", icon: Github },
  { label: "Twitter", href: "https://x.com/Prajwal_K_714", icon: Twitter },
  { label: "LinkedIn", href: "https://www.linkedin.com/in/prajwal-kowndinya-7506b4268/", icon: Linkedin },
]
